...
1. **Określenie modułów systemu:**
   ...
   1. **Panel zamówień:** menu z pizzami, personalizacja pizzy, koszyk, komentarz do zamówienia, finalizacja zamówienia, przewidywany czas dostawy, obszar realizacji zamówień, status zamówienia.
